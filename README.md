...
- **Week-tab**: staafdiagram van één week (ma t/m zo), één gestapelde kolom per dag, één kleur per opdrachtgever.
  - **Bladeren**: met de pijltjes ‹ › (of door over de grafiek te vegen) naar eerdere weken; vooruit voorbij de huidige week kan niet. "Naar deze week" springt terug. Boven de grafiek staan het weeknummer, de datums en het weektotaal.
  - **Maatstaf**: stippellijnen op 4 en 8 uur (halve en hele dag) om in één oogopslag te zien welke dagen kort zijn. Bewust geen vast dagdoel en geen waarschuwingskleuren, omdat je uren flexibel zijn; de as groeit mee in stappen van 4 uur bij langere dagen.
  - **Dag aantikken**: toont onder de grafiek de uren per opdrachtgever en project van die dag. Tik op een project om de regels te wijzigen of te verwijderen; met **+ Uren** log je direct uren op die dag (datum staat al ingevuld — handig om een vergeten dag achteraf aan te vullen).
  - **Kleuren**: vast per opdrachtgever, in volgorde van de eerste keer dat er uren op gelogd zijn (een nieuwe opdrachtgever verkleurt de andere dus niet). Er zijn 8 kleuren; de 9e opdrachtgever en verder vallen samen onder een grijze "Overig" in de grafiek (in het dagdetail staan ze wel met naam). De legenda onder de grafiek toont per week alleen de opdrachtgevers met uren.
  - Een lopende timer telt pas mee zodra je 'm stopt.
